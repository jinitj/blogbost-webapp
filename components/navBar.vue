...
const onLogout = async () => {
  authStore.$reset();
  await navigateTo("/account/signIn", { replace: true });
};
      ...
      <div class="flex items-center justify-between h-16">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <a href="/home" class="text-white  text-xl">Rettiwt</a>
          </div>
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline">
              <NuxtLink
                to="/home"
                class="px-3 py-2 rounded-md text-sm  text-white hover:text-gray-300"
                >Home</NuxtLink
              >
              <NuxtLink
                to="/user/timeline"
                class="ml-4 px-3 py-2 rounded-md text-sm text-white hover:text-gray-300"
                v-if="authStore.userSession.isAuthenticated"
                >Feed
              </NuxtLink>
              <NuxtLink
                to="/user/teewt"
        ...
        <div v-if="!authStore.userSession.isAuthenticated" class="hidden md:block">
        ...
        <div class="md:hidden z-50">
          ...
          >
            ...
            >
              ...
              <div v-if="!authStore.userSession.isAuthenticated">
